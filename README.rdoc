...
Install the hoptoad_notifier Gem. Once installed, you should 
vendor the hoptoad_notifier gem.

  cd vendor/gems
  gems unpack hoptoad_notifier

And then add the following to the 
Rails::Initializer.run do |config| block in environment.rb
